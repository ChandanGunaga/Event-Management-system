        ...
        <div class="row about-container">
          <div class="col-lg-6 content order-lg-1 order-2">
            ...
            <div class="icon-box wow fadeInUp">
              ...
              <h4 class="title"><a href="#">Birthday</a></h4>
              <p class="description" style="text-align:justify">Birthday parties are a great boost to any child's self-esteem. Making them feel like kings (or queens) for the day is one of the best (and most lasting) gifts you can give them. But where and how should you start?
...
Place</p>
        ...
        <div class="row about-extra">
          ...
          <div class="col-lg-6 wow fadeInUp pt-5 pt-lg-0">
            <h4>WEDDING</h4>
            <p>
              The people who make up the wedding party (the bride and groom, the bridesmaids and groomsmen, the flower girl and ring bearer, or the father and mother of the bride) are basically the MVPs of the big day. Get bridal party fashion advice, etiquette tips, gift ideas, and more. </p>
            <p>
            </p>
          </div>
        </div>
...
Do not dwell in the past, do not dream of the future,<br> concentrate the mind on the present moment.</p>
						...
						<div class="col-lg-3 col-md-6 footer-contact">
							...
							<p>
								...
								Jayanagar<br>
								Bangalore-560042 <br>
								<strong>Phone:</strong> +91 9538083312<br>
